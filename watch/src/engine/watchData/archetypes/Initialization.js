...
export class Initialization extends Archetype {
    preprocess() {
        ...
        ui.metric.primary.value.set({
            anchor: uiRect.lt.add(new Vec(0.715, -0.035).mul(ui.configuration.metric.primary.scale)),
            pivot: { x: 1, y: 1 },
        ...
        ui.combo.value.set({
            ...
            rotation: 0,
            alpha: options.hideUi ? 0 : options.customCombo || (options.autoCombo && !replay.isReplay) ? 0 : ui.configuration.combo.alpha,
            horizontalAlign: HorizontalAlign.Center,
            background: false,
        });
        ui.combo.text.set({
        ...
        ui.judgment.set({
            ...
            rotation: 0,
            alpha: options.hideUi ? 0 : options.customJudgment ? 0 : ui.configuration.judgment.alpha,
            horizontalAlign: HorizontalAlign.Center,
            background: false,
        });
        ui.progress.set({
        ...
        for (const archetype of Object.values(archetypes)) {
            if (!('globalPreprocess' in archetype))
                continue;
