...
(function (Mode) {
    ...
    Mode[Mode["OverlayIn"] = 1] = "OverlayIn";
    Mode[Mode["OverlayOut"] = 2] = "OverlayOut";
    Mode[Mode["FallIn"] = 3] = "FallIn";
    Mode[Mode["FallOut"] = 4] = "FallOut";
    Mode[Mode["Frozen"] = 5] = "Frozen";
    Mode[Mode["Active"] = 6] = "Active";
})(Mode || (Mode = {}));
    ...
    update() {
        ...
        if (mode === Mode.FallOut || mode === Mode.Active) {
            ...
            sprites.glow.draw({
                ...
                y3: 1 - h,
                y4: 1,
            }, layer.connectorSlotGlowEffect, (Math.sin(segment.time * 8 * Math.PI) + 1) / 20 + 0.1);
        }
    },
    showOverlayIn() {
        mode = Mode.OverlayIn;
